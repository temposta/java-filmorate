...
public class FilmRepository extends BaseRepository<Film> {
    private static final String FIND_BY_ID_QUERY = """
            SELECT f.*, mpa.name as mpa_name, dir.name as director_name,
    ...
    private static final String INSERT_QUERY = """
            INSERT INTO film (name, description, release_date, duration, rating, director_id)
            VALUES (?, ?, ?, ?, ?, ?)""";
    ...
    private static final String UPDATE_QUERY = """
            UPDATE film SET name = ?, description = ?, release_date = ?, duration = ?, rating = ?, director_id = ?
            WHERE id = ?""";
