...
ALTER TABLE film_director ADD FOREIGN KEY (director_id) REFERENCES director (id) ON DELETE CASCADE;

ALTER TABLE film_director ADD FOREIGN KEY (film_id) REFERENCES film (id) ON DELETE CASCADE;
