...
*Примечание: схема БД в проекте в целом будет соответствовать диаграмме. Однако, в процессе
реализации, была несколько упрощена. Ряд ограничений целостности не применен, 
триггеры и функции не реализовывались*


### Техническое задание (спринт № 12)

## Создание базы данных
Сформирована схема базы данных на основе встроенной СУБД H2 (файл `schema.sql`)

### Работа с DAO
Имплементированы интерфейсы репозиториев для работы с таблицами базы данных.
Выполнение запросов к БД выполнено через `JdbcTemplate`

### Тестирование
Реализованы тесты для репозиториев, сервисов. Тестирование производилось с помощью 2 подходов:
1. Программной настройкой DataSource, jdbc
2. Декларативным подходом - с помощью аннотаций

Проверено прохождение тестов Postman-коллекции.

### Доработка бизнес-логики
Добавлены новые енд-поинты для работы с жанрами и MPA.
